...
# Author: Palash Roy
# DevOps 2019
# This Script shuod open file from ./tmp and start read all the files and will find
# The IP address and replace with the new one as well as create a file *.upd
